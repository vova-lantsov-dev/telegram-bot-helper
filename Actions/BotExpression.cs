...
namespace Telegram.Bot.Helper.Actions
{
    ...
    {
        public readonly Func<Message, Task<bool>> Expression;
        public readonly Func<Message, Verify, Task> Callback;
        public readonly Verify Verified;

        public BotExpression(Func<Message, Task<bool>> expression,
        ...
        public class Builder
        {
            ...
            public Builder(List<BotExpression> expressionList) => _expressionList = expressionList;
            
            public Func<Message, Verify, Task> this[Func<Message, Task<bool>> expression,
